...
const char * const BITCOIN_CONF_FILENAME = "bitcoinclean.conf";
const char * const BITCOIN_PID_FILENAME = "bitcoincleand.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "bitcoinClean";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/bitcoinClean";
#else
    // Unix
    return pathRet / ".bitcoinclean";
#endif
#endif
}
