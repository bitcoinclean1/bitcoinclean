...
#else
        vSeeds.emplace_back("seed.bitcoinclean.org", true); // Peter Todd, only supports x1, x5, x9, and xd
#endif
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("seed.bitcoinclean.org", true);
