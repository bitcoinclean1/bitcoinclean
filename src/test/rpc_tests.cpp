...
BOOST_AUTO_TEST_CASE(rpc_rawparams)
{
    ...
    BOOST_CHECK_THROW(CallRPC(std::string("signrawtransaction ")+rawtx+" null null NONE|ANYONECANPAY"), std::runtime_error);
    BOOST_CHECK_THROW(CallRPC(std::string("signrawtransaction ")+rawtx+" [] [] NONE|ANYONECANPAY"), std::runtime_error);
